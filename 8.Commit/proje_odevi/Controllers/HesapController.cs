...
namespace proje_odevi.Controllers
{
 ...
 public IActionResult ProfilChangeAdSoyad([Required] [StringLength(50)]string? AdSoyad)
 {
        ...
        [HttpPost]
        public IActionResult ProfilChangeSifre([Required(ErrorMessage ="Boş Bırakmayınız")][MinLength(6,ErrorMessage ="En az 6 karakter olmalı")] [MaxLength(16,ErrorMessage ="En fazla 16 karakter olamlı")] string Sifre)
        {
